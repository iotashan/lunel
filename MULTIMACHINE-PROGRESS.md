...
- [ ] (20) cli: direct-mode ws listener reusing V2 handshake
- [ ] (30) cli: Tailscale detection + machine metadata advertise
- [ ] (40) cli: direct-mode QR + short-code (secret NOT in URL)
